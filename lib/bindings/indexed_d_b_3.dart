...
class IDBObjectStore {
  ...
  ///  delete one specific record out of our object store using delete() — a
  ///  sample record with the key "Walk dog". For a full working example, see our To-do Notifications app
  ///   (view example live.)
  ///
  /// // Let us open our database
  /// var DBOpenRequest = window.indexedDB.open("toDoList", 4);
...
///
///  Note: Not to be confused with [IDBCursorWithValue] which is just
/// an interface with an additional [value] property.
