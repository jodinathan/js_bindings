...
///
///
///  The [EXT_sRGB] extension is part of the WebGL API and adds sRGB
/// support to textures and framebuffer objects.
///
...
/// available on the WebGL2 context by default. The constants in
/// WebGL2 are: [gl.SRGB], [gl.SRGB8], [gl.SRGB8_ALPHA8] and
