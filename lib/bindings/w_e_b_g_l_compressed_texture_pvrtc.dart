...
///
///
///  The [WEBGL_compressed_texture_pvrtc] extension is part of the
/// WebGL API and exposes four PVRTC compressed texture formats.
///
...
///  Availability: PVRTC is typically only available on mobile
/// devices with PowerVR chipsets. It is used in all generations of
/// the iPhone, iPod Touch and iPad and supported on certain Android
/// devices that use a PowerVR GPU.
///
