...
///
///
///  The [EXT_color_buffer_half_float] extension is part of the WebGL
/// API and adds the ability to render to 16-bit floating-point color
/// buffers.
///
...
/// WebGL2 contexts. On WebGL 2, it's an alternative to using the
