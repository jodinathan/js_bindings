...
class XRSessionInit {
  external factory XRSessionInit(
      {Iterable<String>? requiredFeatures, Iterable<String>? optionalFeatures});
}
...
extension PropsXRSessionInit on XRSessionInit {
  ...
  set requiredFeatures(Iterable<String> newValue) {
    js_util.setProperty(this, 'requiredFeatures', newValue);
  }

  Iterable<String> get optionalFeatures =>
      js_util.getProperty(this, 'optionalFeatures');
  set optionalFeatures(Iterable<String> newValue) {
...
extension PropsXRSession on XRSession {
  ...
  Iterable<String> get enabledFeatures =>
      js_util.getProperty(this, 'enabledFeatures');
...
class XRRigidTransform {
  external factory XRRigidTransform._(
...
@JS()
@staticInterop
class XRInputSourceArray extends JsIterable<XRInputSource> {
...
class XRWebGLLayer implements XRLayer {
  external factory XRWebGLLayer._(XRSession session, dynamic context,
